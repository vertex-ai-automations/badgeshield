...
The badges below are generated by badgeshield itself — no shields.io, no network calls.

### Project badges

| Badge | Preset |
|---|---|
| ![version](docs/badges/version.svg) | `badgeshield preset version` |
| ![python](docs/badges/python.svg) | `badgeshield preset python` |
| ![branch](docs/badges/branch.svg) | `badgeshield preset branch` |
| ![ruff](docs/badges/ruff.svg) | `badgeshield preset ruff` |
| ![mypy](docs/badges/mypy.svg) | `badgeshield preset mypy` |
| ![maintained](docs/badges/maintained.svg) | `badgeshield preset maintained` |
| ![library](docs/badges/library.svg) | `badgeshield preset library` |
| ![cross-platform](docs/badges/cross-platform.svg) | `badgeshield preset cross-platform` |

### Templates

| Template | Preview |
|---|---|
| `DEFAULT` | ![default](docs/badges/template-default.svg) |
| `PILL` | ![pill](docs/badges/template-pill.svg) |
| `CIRCLE` | ![circle](docs/badges/template-circle.svg) |
| `BANNER` | ![banner](docs/badges/template-banner.svg) |

### Styles (DEFAULT template)

| Style | Preview |
|---|---|
| `FLAT` | ![flat](docs/badges/showcase-flat.svg) |
| `ROUNDED` | ![rounded](docs/badges/showcase-rounded.svg) |
| `GRADIENT` | ![gradient](docs/badges/showcase-gradient.svg) |
| `SHADOWED` | ![shadowed](docs/badges/showcase-shadowed.svg) |
