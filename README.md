...
| Badge | Preset |
|---|---|
| ![version](https://raw.githubusercontent.com/vertex-ai-automations/badgeshield/main/docs/badges/version.svg) | `badgeshield preset version` |
| ![python](https://raw.githubusercontent.com/vertex-ai-automations/badgeshield/main/docs/badges/python.svg) | `badgeshield preset python` |
| ![branch](https://raw.githubusercontent.com/vertex-ai-automations/badgeshield/main/docs/badges/branch.svg) | `badgeshield preset branch` |
| ![ruff](https://raw.githubusercontent.com/vertex-ai-automations/badgeshield/main/docs/badges/ruff.svg) | `badgeshield preset ruff` |
| ![mypy](https://raw.githubusercontent.com/vertex-ai-automations/badgeshield/main/docs/badges/mypy.svg) | `badgeshield preset mypy` |
| ![maintained](https://raw.githubusercontent.com/vertex-ai-automations/badgeshield/main/docs/badges/maintained.svg) | `badgeshield preset maintained` |
| ![library](https://raw.githubusercontent.com/vertex-ai-automations/badgeshield/main/docs/badges/library.svg) | `badgeshield preset library` |
| ![cross-platform](https://raw.githubusercontent.com/vertex-ai-automations/badgeshield/main/docs/badges/cross-platform.svg) | `badgeshield preset cross-platform` |

### Templates

| Template | Preview |
|---|---|
| `DEFAULT` | ![default](https://raw.githubusercontent.com/vertex-ai-automations/badgeshield/main/docs/badges/template-default.svg) |
| `PILL` | ![pill](https://raw.githubusercontent.com/vertex-ai-automations/badgeshield/main/docs/badges/template-pill.svg) |
| `CIRCLE` | ![circle](https://raw.githubusercontent.com/vertex-ai-automations/badgeshield/main/docs/badges/template-circle.svg) |
| `BANNER` | ![banner](https://raw.githubusercontent.com/vertex-ai-automations/badgeshield/main/docs/badges/template-banner.svg) |

### Styles (DEFAULT template)

| Style | Preview |
|---|---|
| `FLAT` | ![flat](https://raw.githubusercontent.com/vertex-ai-automations/badgeshield/main/docs/badges/showcase-flat.svg) |
| `ROUNDED` | ![rounded](https://raw.githubusercontent.com/vertex-ai-automations/badgeshield/main/docs/badges/showcase-rounded.svg) |
| `GRADIENT` | ![gradient](https://raw.githubusercontent.com/vertex-ai-automations/badgeshield/main/docs/badges/showcase-gradient.svg) |
| `SHADOWED` | ![shadowed](https://raw.githubusercontent.com/vertex-ai-automations/badgeshield/main/docs/badges/showcase-shadowed.svg) |
