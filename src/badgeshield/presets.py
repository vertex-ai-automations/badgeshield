...
from pathlib import (
    Path,
)  # kept for get_type_hints() resolution of Callable[[Path], str]
...
class Preset:
    ...
    right_color: str = (
        "#555555"  # right panel color; maps to BadgeGenerator right_color kwarg
    )
    description: str = ""
...
PRESETS: Dict[str, Preset] = {
    ...
    "python": Preset(
        label="python",
        color=BadgeColor.DARK_BLUE,
        source=get_python_requires,
        description="Python version requirement from pyproject.toml or setup.py",
    ),
    "branch": Preset(
        label="branch",
        color=BadgeColor.DARK_CYAN,
        source=get_git_branch,
        description="Current git branch name",
    ),
    "tag": Preset(
        label="tag",
        color=BadgeColor.DARK_GREEN,
        source=get_git_tag,
    ...
    "commits": Preset(
        label="commits",
        color=BadgeColor.DARK_GRAY,
        source=get_git_commit_count,
        description="Total git commit count",
    ),
    "repo-status": Preset(
        label="repo",
        color=BadgeColor.GREEN,
        source=get_git_status,
        description="Git working tree status: clean or dirty",
    ),
    "lines": Preset(
        label="lines",
        color=BadgeColor.DARK_PURPLE,
        source=get_lines_of_code,
    ...
    "contributions-welcome": Preset(
        label="contributions",
        color=BadgeColor.PASTEL_PURPLE,
        right_text="welcome",
    ...
    "hacktoberfest": Preset(
        label="hacktoberfest",
        color=BadgeColor.DARK_PURPLE,
        right_text="hacktoberfest",
        description="Project participates in Hacktoberfest",
    ),
    # --- Platform ---
    "cross-platform": Preset(
        label="platform",
        color=BadgeColor.DARK_BLUE,
        right_text="cross-platform",
